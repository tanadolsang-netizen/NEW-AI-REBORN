...
const translations = {
  th: {
    ...
    journal: {
      ...
      subtitle: 'บันทึกอารมณ์ ความเครียด การนอน พลังงาน และข้อคิด',
      mood: 'อารมณ์',
      stress: 'ความเครียด',
      sleep: 'ชั่วโมงนอน',
      ...
      energy: 'พลังงาน',
      reflection: 'ลอง reflect ดู',
      export: 'ส่งออก CSV',
      summary: 'สรุป 7 วันล่าสุด',
      entries: 'บันทึก',
      actionableInsight: 'ข้อเสนอปฏิบัติ',
      reflectionPrompt: 'วันนี้อะไรทำให้คุณรู้สึกมีความสุข?',
    },
    energy: {
      title: 'พยากรณ์พลังงานชีวิต',
      subtitle: 'พลังงานจากตำแหน่งดาว และจังหวะชีวิตประจำวัน',
    ...
    journal: {
      ...
      subtitle: 'Track mood, stress, sleep, energy, and reflections',
      mood: 'Mood',
      stress: 'Stress',
      sleep: 'Sleep',
      note: 'Notes',
      ...
      stressLabels: ['Chill', 'Calm', 'Mild', 'Tense', 'High'],
      energy: 'Energy',
      ...
      reflectionPrompt: 'What brought you joy today?',
    },
    auth: {
      loginTitle: 'Sign in',
