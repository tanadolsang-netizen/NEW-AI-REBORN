...
const translations = {
  th: {
    ...
    hero: {
      ...
      title: 'คำนวณดวง + จัดการชีวิตได้',
      titleSub: 'ความแม่นยำจากดาราศาสตร์',
      body: 'คำนวณ ephemeris offline แบบ standalone ไม่พึ่ง API ภายนอก ผสานชีวิตจริงด้วย tracking + actionable insights',
      cta1: 'คำนวณดวงเกิด',
  ...
  en: {
    ...
    hero: {
      ...
      title: 'Calculate your chart + manage life',
      titleSub: 'Precision from the stars',
      body: 'Offline-first ephemeris engine. No external APIs. Complete astrological branches + actionable life tracking in one place.',
